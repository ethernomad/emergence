...
BuildRequires: meson >= 0.56, pkgconfig(sdl), pkgconfig(openssl), pkgconfig(zlib), pkgconfig(libpng), pkgconfig(x11), pkgconfig(xrandr), pkgconfig(alsa), pkgconfig(vorbisfile), pkgconfig(gl), pkgconfig(glu)
